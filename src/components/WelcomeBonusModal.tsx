...
export function WelcomeBonusModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md rounded-[2rem] border-none shadow-2xl p-0 overflow-hidden bg-card">
        ...
        <div className="p-8 text-center space-y-6">
          ...
          <div className="bg-primary/5 rounded-2xl p-6 flex flex-col items-center justify-center border border-primary/10 gap-2 scale-105 transition-transform duration-500 hover:scale-110">
            <div className="text-4xl font-black text-primary tracking-tighter flex items-center gap-2">
              <Coins className="h-8 w-8" />
              50
              <span className="text-sm opacity-60 font-black uppercase tracking-widest ml-1">Points</span>
            </div>
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/60">Ready to claim</p>
          </div>
          ...
          <DialogFooter className="sm:justify-center pt-2">
            <Button 
              onClick={handleClaim} 
              disabled={loading}
              className="w-full h-14 rounded-2xl text-lg font-black uppercase tracking-tight shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              {loading ? (
                <>
