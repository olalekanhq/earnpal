              ...
              {notifications?.map((notification) => (
                ...
                >
                  <p className="text-sm font-medium">
                    {"'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            the thext below is what you just add to notification panel, please remove it and use what suppose to be there\n\n'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.''' Add deep links in each notification so I can click through to the specific referee and referral details immediately."}
                  </p>
