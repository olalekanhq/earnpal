...
export function Navigation() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="md:hidden sticky top-0 left-0 z-40 w-full flex items-center justify-between h-16 px-4 bg-white/80 backdrop-blur-md border-b border-border/50">
