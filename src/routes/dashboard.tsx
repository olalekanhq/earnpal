  ...
  return (
    <div className="pb-12 px-4 md:px-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Daily Streak Card */}
        <Card className="border-none shadow-sm flex flex-col relative overflow-hidden bg-white">
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-muted-foreground uppercase">Daily Streak</CardTitle>
          ...
          <CardContent className="pt-2 flex-1 flex flex-col justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">Keep claiming daily to earn bonus points!</p>
            </div>
            <div className="mt-6">
              <Button 
                className={cn(
      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <Link to="/earn" className="text-sm font-bold text-primary hover:underline">View all</Link>
          </div>
