...
function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-4 relative pt-24 md:pt-4 no-scrollbar overflow-x-clip max-w-[100vw]">
      ...
      <div className="w-full max-w-[100vw] grid grid-cols-1 lg:grid-cols-2 gap-8 items-center justify-items-center relative z-10 overflow-hidden">
        {/* Auth Card Side */}
