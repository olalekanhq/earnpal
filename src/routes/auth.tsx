            ...
            <CardHeader className="space-y-1 text-center pb-4 p-0 flex-shrink-0">
              ...
              <span className="sr-only whitespace-normal break-words w-px h-px overflow-hidden absolute">
                '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                            ...
                                            Implement the Admin Tools dropdown so it ONLY opens on tap/click. Ensure hover effects or accidental scrolls cannot trigger it. Verify click-outside closing works perfectly.
              </span>
