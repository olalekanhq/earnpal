...
export const Route = createFileRoute("/_authenticated/transactions")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Detailed view of your point earnings and spending on Noble Gain.",
      },
    ],
  }),
...
function TransactionsPage() {
  ...
  return (
    <div className="premium-enter mx-auto flex max-w-4xl flex-col gap-8 px-4 pb-12 md:px-8">
      <header className="space-y-1">
        <h1 className="text-3xl font-black tracking-tight text-foreground">Transaction History</h1>
        <p className="text-muted-foreground font-medium">
          Detailed view of your point earnings and spending.
        </p>
      </header>
